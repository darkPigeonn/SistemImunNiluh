package com.gratiasdeveloper.sistemimunniluh.Chat;
...
//                showFirebaseLoginPrompt();
        ...
        mName = getIntent().getExtras().get("user_name").toString();
        userId = Integer.parseInt(getIntent().getExtras().get("id_user").toString());
        String room_name = getIntent().getExtras().get("room_name").toString();


        mRef = new Firebase("https://niluh-268c9-default-rtdb.firebaseio.com/"+room_name);
